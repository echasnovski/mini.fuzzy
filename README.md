...
<!-- [![GitHub tag](https://badgen.net/github/tag/echasnovski/mini.fuzzy)](https://github.com/echasnovski/mini.fuzzy/tags/) -->
<!-- [![Current version](https://badgen.net/badge/Current%20version/development/cyan)](https://github.com/echasnovski/mini.fuzzy/blob/main/CHANGELOG.md) -->
<!-- badges: end -->

**Minimal and fast fuzzy matching**

See more details in [help file](doc/mini-fuzzy.txt).
...
<table>
    ...
    <tbody>
        ...
        <!-- <tr> -->
        <!--     <td rowspan=2>Standalone plugin</td> <td>Main</td> <td><code>use 'echasnovski/mini.fuzzy'</code></td> -->
        <!-- </tr> -->
        <!-- <tr> -->
        <!--     <td>Stable</td> <td><code>use { 'echasnovski/mini.fuzzy', branch = 'stable' }</code></td> -->
        <!-- </tr> -->
    </tbody>
</table>
...
**Important**: don't forget to call `require('mini.fuzzy').setup()` to enable its functionality.
